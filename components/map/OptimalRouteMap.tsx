...
import MapView, { Marker, Polyline, PROVIDER_GOOGLE } from '@/lib/platform/maps-compat';
import { FontAwesome } from '@expo/vector-icons';
import { getOptimalRoute, LatLon, RouteResult } from '@/features/trips/services/routing.service';
