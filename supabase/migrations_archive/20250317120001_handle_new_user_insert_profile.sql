-- On sign-up, also insert a row into public.profiles so profile data is stored there (phone, role, etc.).
...
BEGIN
  ...
  INSERT INTO public.profiles (
    id, email, full_name, role, phone, company_name, avatar_url, aggregated, asset
  ) VALUES (
    NEW.id,
    NEW.email,
    display_name,
