-- Exclude soft-deleted indents from Find Work / Load Center market feed.
-- Hard-deleted rows are already absent; this prevents ghost loads when deleted_at is set.
...
COMMENT ON FUNCTION public.market_indents_for_org(uuid) IS
  'Find Work / Load Center: partner-link indents (excludes deleted_at) plus awarded-to-caller.';
