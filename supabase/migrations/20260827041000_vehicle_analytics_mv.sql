...
CREATE INDEX IF NOT EXISTS idx_trips_vehicle_pickup_date
  ON trips (vehicle_id, pickup_date DESC)
  WHERE vehicle_id IS NOT NULL;

CREATE INDEX IF NOT EXISTS idx_trips_vehicle_id_status
...
CREATE INDEX IF NOT EXISTS idx_trips_vehicle_display_number
