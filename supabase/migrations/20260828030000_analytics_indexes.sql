...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_trips_completed_lifecycle
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_transactions_client_contact
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_transactions_supplier_contact
  ON public.transactions (organization_id, contact_id, transaction_date DESC)
