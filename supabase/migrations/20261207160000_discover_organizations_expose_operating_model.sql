-- Expose counterparty operating_model in discover_organizations so the connect
-- role picker (client vs supplier) can be gated by BOTH orgs' operating models.
-- Additive: appends operating_model to the RETURNS TABLE; scoring unchanged.
