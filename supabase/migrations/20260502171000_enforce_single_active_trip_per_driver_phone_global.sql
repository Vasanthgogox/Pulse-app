-- Re-apply single-active-trip trigger with phone-global guard.
-- Important: this is a NEW migration because editing an already-applied migration
-- file does not change remote DB objects.
