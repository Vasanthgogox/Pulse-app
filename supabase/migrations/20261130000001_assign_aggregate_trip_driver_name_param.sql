-- Ensure assign_aggregate_trip_driver accepts dispatcher-entered p_driver_name
-- so trips.driver_display_name / hub party chips show the real name (not UNASSIGNED).
-- Linked remote already has this signature; CREATE OR REPLACE keeps local + remote aligned.
