...
DROP FUNCTION IF EXISTS public.get_multi_lane_bootstrap(uuid, integer, integer, integer);
DROP FUNCTION IF EXISTS public.get_unified_b2b_bootstrap(uuid, integer, integer, integer);
DROP FUNCTION IF EXISTS public.get_b2b_chat_bootstrap(uuid, integer, integer, integer);
DROP FUNCTION IF EXISTS public.get_whatsapp_bootstrap_data(uuid, integer, integer, integer);
DROP FUNCTION IF EXISTS public.get_initial_chat_state(uuid, integer, integer, integer);
...
REVOKE ALL    ON FUNCTION public.get_initial_chat_state(UUID, INT, INT, INT, TEXT) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.get_initial_chat_state(UUID, INT, INT, INT, TEXT) TO authenticated;

COMMENT ON FUNCTION public.get_initial_chat_state(UUID, INT, INT, INT, TEXT) IS
...
REVOKE ALL    ON FUNCTION public.get_whatsapp_bootstrap_data(UUID, INT, INT, INT, TEXT) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.get_whatsapp_bootstrap_data(UUID, INT, INT, INT, TEXT) TO authenticated;
...
REVOKE ALL    ON FUNCTION public.get_b2b_chat_bootstrap(UUID, INT, INT, INT, TEXT) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.get_b2b_chat_bootstrap(UUID, INT, INT, INT, TEXT) TO authenticated;
...
COMMENT ON FUNCTION public.get_unified_b2b_bootstrap(UUID, INT, INT, INT, TEXT) IS
  'Unified bootstrap: conversations + messages_by_context; indent_status; optional trip window; hub bucket.';

REVOKE ALL ON FUNCTION public.get_unified_b2b_bootstrap(UUID, INT, INT, INT, TEXT) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.get_unified_b2b_bootstrap(UUID, INT, INT, INT, TEXT) TO authenticated;
...
COMMENT ON FUNCTION public.get_multi_lane_bootstrap(UUID, INT, INT, INT, TEXT) IS
  'Multi-lane bootstrap: conversations + lanes + messages_by_context; optional trip window; hub bucket.';

REVOKE ALL ON FUNCTION public.get_multi_lane_bootstrap(UUID, INT, INT, INT, TEXT) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.get_multi_lane_bootstrap(UUID, INT, INT, INT, TEXT) TO authenticated;
