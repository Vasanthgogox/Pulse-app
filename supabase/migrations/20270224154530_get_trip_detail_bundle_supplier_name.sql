-- Include suppliers.name + organizations.name in trip detail bundle supplier_detail.
-- Fixes "Awaiting data" under supplier logo when company_name is null (e.g. Ajio).
-- Non-midnight timestamp to avoid collision with pulse-unified-base midnight versions.
