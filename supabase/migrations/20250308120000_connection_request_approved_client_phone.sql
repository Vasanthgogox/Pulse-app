-- Fix on_connection_request_approved: clients.phone is NOT NULL and UNIQUE(organization_id, phone).
-- Use a placeholder phone for linked-org clients so INSERT succeeds and remains unique per org.
...
BEGIN
  ...
  -- Placeholder phone for linked-org client rows (NOT NULL, unique per org)
  ...
  -- To_org: add from_org as client (link or create). clients.phone is NOT NULL and UNIQUE(organization_id, phone).
