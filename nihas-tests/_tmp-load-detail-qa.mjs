...
const OTP = '2204';
const OUT = '/private/tmp/claude-501/-Users-ggx-Desktop-Pulse-app/aa0cd08c-fbaa-43db-a775-ddb930ada764/scratchpad/load_detail_shots';

const log = (m) => console.log(`[load-detail-qa] ${m}`);
