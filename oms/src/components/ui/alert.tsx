  ...
  'flex items-stretch w-full gap-2 group-[.toaster]:w-(--width)',
  {
    ...
    compoundVariants: [
      ...
      },
      {
        ...
        appearance: 'solid',
        className:
          'bg-[var(--color-info,var(--pulse-hero-blue))] text-[var(--color-info-foreground,var(--color-white))]',
      },
      {
        variant: 'warning',
        appearance: 'solid',
      ...
      },
      {
        ...
        appearance: 'outline',
        className:
          'border border-border bg-background text-[var(--color-info,var(--pulse-hero-blue))] [&_[data-slot=alert-close]]:text-foreground',
      },
      {
        variant: 'warning',
        appearance: 'outline',
      ...
      },
      {
        ...
        appearance: 'light',
        className:
          'bg-[var(--color-info-soft,var(--pulse-brand-soft))] border border-[var(--color-info-alpha,var(--pulse-brand-fill))] text-foreground [&_[data-slot=alert-icon]]:text-[var(--color-info-foreground,var(--pulse-hero-blue))] dark:bg-[var(--color-info-soft,var(--pulse-hero-blue))] dark:border-[var(--color-info-alpha,var(--pulse-brand-blue))]',
      },
      {
        variant: 'warning',
        appearance: 'light',
      ...
      },
      {
        ...
        icon: 'info',
        className:
          '[&_[data-slot=alert-icon]]:text-[var(--color-info-foreground,var(--pulse-hero-blue))]',
      },
    ],
    defaultVariants: {
      variant: 'secondary',
