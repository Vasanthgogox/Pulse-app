  ...
  'inline-flex items-center justify-center border border-transparent font-medium focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2 [&_svg]:-ms-px [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        info: 'bg-[var(--color-info-accent,var(--pulse-hero-blue))] text-[var(--color-info-foreground,var(--color-white))]',
        outline:
    ...
    compoundVariants: [
      ...
      },
      {
        ...
        appearance: 'light',
        className:
          'text-[var(--color-info-accent,var(--pulse-hero-blue))] bg-[var(--color-info-soft,var(--pulse-brand-soft))] dark:bg-[var(--color-info-soft,var(--pulse-hero-blue))] dark:text-[var(--color-info-soft,var(--pulse-brand-blue))]',
      },
      {
        variant: 'destructive',
        appearance: 'light',
      ...
      },
      {
        ...
        appearance: 'outline',
        className:
          'text-[var(--color-info-accent,var(--pulse-hero-blue))] border-[var(--color-info-soft,var(--pulse-brand-fill))] bg-[var(--color-info-soft,var(--pulse-brand-soft))] dark:bg-[var(--color-info-soft,var(--pulse-hero-blue))] dark:border-[var(--color-info-soft,var(--pulse-brand-blue))] dark:text-[var(--color-info-soft,var(--pulse-brand-blue))]',
      },
      {
        variant: 'destructive',
        appearance: 'outline',
      ...
      },
      {
        variant: 'info',
        appearance: 'ghost',
        className: 'text-[var(--color-info-accent,var(--pulse-hero-blue))]',
      },
      {
        variant: 'destructive',
        appearance: 'ghost',
