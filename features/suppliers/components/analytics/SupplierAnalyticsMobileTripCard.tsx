...
export const SupplierAnalyticsMobileTripCard = memo(
  function SupplierAnalyticsMobileTripCard({ row, paid, due }: Props) {
    ...
    const cost = row.cost > 0 ? row.cost : row.sales;
      ...
      <View style={styles.card}>
        ...
        <View style={styles.metrics}>
          <View style={styles.metric}>
            ...
            <Text style={styles.metricValue}>{formatINRChip(cost)}</Text>
          </View>
          <View style={styles.metric}>
