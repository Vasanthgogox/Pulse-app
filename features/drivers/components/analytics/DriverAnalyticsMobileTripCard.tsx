...
export const DriverAnalyticsMobileTripCard = memo(
  function DriverAnalyticsMobileTripCard({ row, earnings, paid, due }: Props) {
      ...
      <View style={styles.card}>
        ...
        <View style={styles.metrics}>
          <View style={styles.metric}>
            ...
            <Text style={styles.metricValue}>{formatINRChip(earnings)}</Text>
          </View>
          <View style={styles.metric}>
