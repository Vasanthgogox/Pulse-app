/**
 * Desktop popup — supplier target keypad (same chrome as client sale).
 */
...
export type IndentTargetDesktopModalProps = {
  visible: boolean;
  onClose: () => void;
  onDone: () => void;
  children: ReactNode;
...
export const IndentTargetDesktopModal = memo(function IndentTargetDesktopModal({
  visible,
  onClose,
  onDone,
  children,
}: IndentTargetDesktopModalProps) {
        ...
        >
          <View style={styles.sheetHeader}>
            <View style={styles.sheetHeaderCopy}>
              <Text style={styles.sheetEyebrow}>Supplier target</Text>
              <Text style={styles.sheetTitle}>Enter target</Text>
            </View>
            <Pressable
              onPress={onClose}
          ...
          >
            <ScrollView
              style={[styles.keypadHost, { maxHeight: Math.max(280, sheetMaxH - 72) }]}
              contentContainerStyle={styles.keypadHostContent}
