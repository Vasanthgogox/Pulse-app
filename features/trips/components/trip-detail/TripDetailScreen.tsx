...
import { useShipperDisplayNamesQuery } from "@/lib/queries/useTripsQuery";
...
import { useOpenDisputesQuery, useDisputesReceivedQuery } from "@/lib/queries/useDisputesQuery";
