/**
 * Centered fleet picker — reference layout: title, search, rich rows, dark footer.
 */
...
import { Search, Truck, User, X } from "lucide-react-native";
...
export function FleetEntityPickerModal({
  ...
  const listRows = mode === "driver" ? filteredDrivers : filteredVehicles;
        ...
        <View style={styles.centerWrap} pointerEvents="box-none">
          <View style={[styles.sheet, { maxWidth: cardMaxW }]}>
            ...
            <View style={styles.searchWrap}>
              ...
              <TextInput
                style={[styles.searchInput, inputChrome]}
            ...
            <View style={styles.sheetFooter}>
              <TouchableOpacity
                style={[styles.footerBtn, webCursor]}
                onPress={onClose}
                activeOpacity={0.85}
              >
