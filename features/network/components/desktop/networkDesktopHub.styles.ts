...
import { NETWORK_HUB_GROW_GRID_COLUMNS } from "@/features/network/constants/networkHubGrid";
...
const networkDesktopHubStylesDef = {
  ...
  growCardGrid: view({
    ...
    ...({
      display: "grid",
      gridTemplateColumns: `repeat(${NETWORK_HUB_GROW_GRID_COLUMNS}, minmax(0, 1fr))`,
      gap: 12,
      alignItems: "stretch",
    } as unknown as ViewStyle),
  }),
  ...
  profileOfficeMapCol: view({
    flex: 1,
    minWidth: 0,
  }),
  profileOfficeContactCol: view({
    width: 240,
    flexGrow: 0,
    flexShrink: 0,
    flexBasis: 240,
  ...
  profileBrandingHalf: view({
    flex: 1,
    minWidth: 0,
    gap: 8,
  }),
  profileOfficeAddressFields: view({
    gap: 8,
    marginTop: 8,
  }),
  profileLocationsGrid: view({
    flexDirection: "row",
    flexWrap: "wrap",
    gap: 10,
    width: "100%",
  }),
  profileLocationCard: view({
    flexDirection: "row",
    alignItems: "center",
    gap: 12,
    flexGrow: 1,
  ...
  profileLocationTitleRow: view({
    flexDirection: "row",
    alignItems: "center",
    gap: 8,
    minWidth: 0,
  }),
  profileLocationTitle: text({
    flex: 1,
    minWidth: 0,
    paddingHorizontal: 0,
    paddingTop: 0,
  ...
  profileLocationVerifiedText: text({
    fontSize: 10,
    fontWeight: "700",
    color: Theme.positive,
    letterSpacing: 0.2,
  }),
  profileLocationHint: text({
    paddingHorizontal: 0,
    paddingTop: 0,
    fontSize: 11,
    fontWeight: "600",
  ...
  profileFieldRow: view({
    flexDirection: "row",
    gap: 8,
    alignItems: "stretch",
  }),
  profileFieldHalf: view({
    flex: 1,
    minWidth: 0,
  }),
  profileMapWrap: view({
  ...
  profileBrandingBlock: view({
    marginTop: 16,
    gap: 8,
  }),
  profileEmptyHint: text({
    fontSize: 12,
    fontWeight: "400",
    fontStyle: "italic",
    color: METRONIC.muted,
  ...
  profileNameField: view({
    flex: 1,
    minWidth: 0,
    marginBottom: 0,
    gap: 4,
  }),
  profileLogoActions: view({
    flexGrow: 0,
    flexShrink: 0,
    flexBasis: "auto",
    flexDirection: "column",
