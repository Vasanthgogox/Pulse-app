...
export function useProfileHubCompactLayout() {
  ...
  return {
    ...
    salesScopeBar: compact ? mobile.salesScopeBarCompact : undefined,
    salesSplitRow: compact ? mobile.salesSplitColumn : undefined,
    salesKpiRow: compact ? mobile.salesKpiRowCompact : undefined,
    salesKpiCard: compact ? mobile.salesKpiCardCompact : undefined,
    salesWidgetRow: compact ? mobile.salesWidgetStackCompact : undefined,
    salesPerfViewBar: compact ? mobile.salesPerfViewBarCompact : undefined,
    salesPerfViewToggle: compact ? mobile.salesPerfViewToggleCompact : undefined,
    salesPerfViewTab: compact ? mobile.salesPerfViewTabCompact : undefined,
    salesTableToolbar: compact ? mobile.salesTableToolbarCompact : undefined,
    salesTableSearch: compact ? mobile.salesTableSearchCompact : undefined,
    salesTableTitleRow: compact ? mobile.salesTableTitleRowCompact : undefined,
    salesPagination: compact ? mobile.salesPaginationCompact : undefined,
