...
export const profileHubLayoutStyles = StyleSheet.create({
  ...
  salesWidgetStackCompact: {
    display: 'flex',
    flexDirection: 'column',
    gap: 8,
    width: '100%',
  },
  salesPerfViewBarCompact: {
    flexDirection: 'column',
    alignItems: 'stretch',
    gap: 10,
    marginBottom: 4,
  },
  salesPerfViewToggleCompact: {
    width: '100%',
    flexShrink: 1,
    gap: 8,
  },
  salesPerfViewTabCompact: {
    flex: 1,
    minHeight: Layout.minTouchTargetSize,
    justifyContent: 'center',
    paddingVertical: 10,
  ...
  salesTableToolbarCompact: {
    flexDirection: 'column',
    alignItems: 'stretch',
    gap: 8,
  },
  salesTableSearchCompact: {
    maxWidth: '100%',
    minWidth: 0,
    width: '100%',
    minHeight: Layout.minTouchTargetSize,
