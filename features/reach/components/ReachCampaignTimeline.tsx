...
const styles = StyleSheet.create({
  ...
  headerRow: { flexDirection: "row", alignItems: "center", gap: 9, paddingBottom: 12, borderBottomWidth: 1, borderBottomColor: Theme.borderInput },
  headerIcon: {
    width: 28,
    height: 28,
    borderRadius: 8,
  ...
  stepSub: { fontSize: 9, fontWeight: "500", color: Theme.textMuted, textAlign: "center" },
});
